...
Checked on September 10, 2026 with Java 17, Android Platform 36, Build Tools 36.0.0, and the included Gradle wrapper.

- `./scripts/test-logic.sh`: passed both standalone test programs. Chart scale invariants cover maxima from 0 through 999,999. Reminder tests cover the 10 PM local default, time-zone conversion, user-selected scheduling, and rejection of stale 3 AM delivery.
