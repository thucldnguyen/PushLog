...
- `./gradlew assembleRelease lintRelease`: passed. Lint reports no errors; localization, SDK update suggestions, and tooling findings remain review items.
...
- Signed release APK: approximately 1.2 MB. This is not a startup or frame-time measurement.
